...
class Questionnaire extends React.Component {
  ...
  handleSubmit(event) {
    this.props.updateProfile(this.state.location, this.state.car_hours, this.state.fly_hours);
  }
    ...
    return (
      <form>
        ...
        <h2>How many hours did you fly this month?</h2>
            <Slider onChange={this.handlePlaneChange} defaultValue={30}/>
        <h2>How much did you drive this month?</h2>
          <Slider onChange={this.handleCarChange} defaultValue={30}/>
        <Link to="/profile" onClick={this.handleSubmit}>Profile</Link>
      </form>
    )
  }
}
